...
function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col px-1 py-2 bg-white w-full">
      <header className="mb-4">
        <h1 className="text-sm font-bold text-center mb-1">HourTrackrr NJHS</h1>
        <p className="text-xs text-center text-gray-600 mb-2">National Junior Honor Society</p>
      </header>
      <main className="flex-1 flex flex-col items-center space-y-3">
        <button className="w-full max-w-[160px] py-2 text-xs font-bold rounded-lg bg-blue-600 text-white shadow mb-2">Get Started</button>
        {/* Sneak Peek Image (tiny) */}
        <div className="flex flex-col items-center w-full mb-2">
          <img
            src={sneakPeakImg}
            alt="Dashboard sneak peek"
            className="rounded-lg shadow border border-gray-200 w-full max-w-[120px] object-contain"
            style={{ maxHeight: '60px' }}
          />
        </div>
        <div className="w-full max-w-[160px] mx-auto p-2 rounded-lg shadow bg-gray-50 mb-2">
          {/* Card 1: Log Your Hours */}
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center mb-2">
              <svg width="16" height="16" fill="none" viewBox="0 0 24 24"><path d="M12 2v20M5 12h14" stroke="#2563EB" strokeWidth="2" strokeLinecap="round"/></svg>
            </div>
            <h3 className="font-bold text-blue-900 mb-1 text-xs text-center">Log Your Hours</h3>
            <p className="text-gray-600 text-xs text-center">Submit hours easily. All submissions stored securely.</p>
          </div>
        </div>
        <div className="w-full max-w-[160px] mx-auto p-2 rounded-lg shadow bg-gray-50 mb-2">
          ...
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 bg-yellow-100 rounded-full flex items-center justify-center mb-2">
              <svg width="16" height="16" fill="none" viewBox="0 0 24 24"><path d="M3 17l6-6 4 4 8-8" stroke="#FBBF24" strokeWidth="2" strokeLinecap="round"/></svg>
            </div>
            <h3 className="font-bold text-yellow-700 mb-1 text-xs text-center">Track Progress</h3>
            <p className="text-gray-600 text-xs text-center">View total hours and history. Stay on top of requirements.</p>
          </div>
        </div>
        <div className="w-full max-w-[160px] mx-auto p-2 rounded-lg shadow bg-gray-50 mb-2">
          ...
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 bg-blue-200 rounded-full flex items-center justify-center mb-2">
              <svg width="16" height="16" fill="none" viewBox="0 0 24 24"><path d="M12 17l-5 3 1-5.5L3 9.5l5.5-.5L12 4l3.5 5 5.5.5-4 5 1 5.5z" stroke="#1e3a8a" strokeWidth="2" strokeLinejoin="round"/></svg>
            </div>
            <h3 className="font-bold text-blue-900 mb-1 text-xs text-center">Get Recognized</h3>
            <p className="text-gray-600 text-xs text-center">Earn recognition for service and leadership. Your impact matters!</p>
          </div>
        </div>
        {/* Contact Section */}
        <div className="bg-white rounded-lg shadow p-2 max-w-[160px] w-full text-center mt-2 border-t-2 border-blue-900 mx-auto">
          <h3 className="font-bold text-blue-900 mb-1 text-xs">Need Help?</h3>
          <p className="text-gray-700 text-xs flex flex-col items-center gap-1">
      ...
      <footer className="text-center text-[10px] text-gray-500 py-2 mt-4">
        ...
        <div className="mt-1">© {new Date().getFullYear()} HourTrackr NJHS.</div>
      </footer>
    </div>
  );
}
