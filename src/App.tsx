...
function Home() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[60vh] px-4 py-4 bg-white">
      ...
      {/* Tagline */}
      <div className="max-w-lg text-center mb-4 fade-in">
        <p className="text-lg text-gray-800 font-montserrat mb-2 text-hover-effect">
      ...
      <div className="w-full max-w-3xl grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-gray-50 rounded-xl shadow-xl p-4 flex flex-col items-center border-t-4 border-accent card-animated fade-in hover:shadow-2xl hover:scale-[1.02] transition-all duration-300" style={{ '--animation-delay': '0.4s' } as React.CSSProperties}>
        ...
        <div className="bg-gray-50 rounded-xl shadow-xl p-4 flex flex-col items-center border-t-4 border-primary-dark card-animated fade-in hover:shadow-2xl hover:scale-[1.02] transition-all duration-300" style={{ '--animation-delay': '0.6s' } as React.CSSProperties}>
      ...
      {/* Contact Section */}
      <div className="bg-white rounded-xl shadow-lg p-4 max-w-md w-full text-center mt-4 border-t-4 border-primary-dark fade-in">
        <h3 className="font-bold text-primary-dark mb-1 font-montserrat text-hover-effect text-base">Need Help?</h3>
      ...
      <div className="w-full flex justify-center">
        <div className="text-gray-400 text-xs mt-6 mb-2 text-center max-w-lg flex flex-wrap items-center justify-center gap-2">
