...
function Home() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[70vh] px-4 py-4 bg-white">
      {/* Logo and Title */}
      <div className="flex flex-col items-center mb-10 mt-20 fade-in">
        ...
        <h1 className="text-6xl font-extrabold text-primary-dark font-montserrat mb-2 drop-shadow-2xl" style={{ letterSpacing: '-0.03em' }}>HourTrackr NJHS</h1>
        <div className="text-2xl text-blue-900 font-montserrat mb-6">National Junior Honor Society</div>
      </div>

      {/* Tagline */}
      <div className="max-w-2xl text-center mb-12 fade-in">
        <p className="text-3xl text-gray-900 font-montserrat mb-2">Log and track your NJHS volunteer hours in one place.</p>
      </div>

      {/* Get Started Button */}
      <button
        onClick={() => navigate('/login')}
        className="mb-16 px-10 py-5 rounded-xl bg-primary text-white font-bold text-2xl shadow-2xl hover:bg-primary-dark transition glow-on-hover"
