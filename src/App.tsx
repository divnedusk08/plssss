...
function Home() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[60vh] px-2 py-2 bg-white">
      {/* Logo and Title */}
      <div className="flex flex-col items-center mb-2 mt-6 fade-in">
        ...
        <h1 className="text-5xl font-extrabold text-primary-dark font-montserrat mt-1 mb-0 drop-shadow">HourTrackr NJHS</h1>
        <div className="text-blue-900 text-xl font-montserrat mb-1">National Junior Honor Society</div>
      </div>

      {/* Tagline */}
      <div className="max-w-xl text-center mb-2 fade-in">
        <p className="text-2xl text-gray-800 font-montserrat mb-1 text-hover-effect">
      ...
      <button
        ...
        className="mb-4 px-6 py-3 rounded-lg bg-primary text-white font-bold text-lg hover:bg-primary-dark transition glow-on-hover"
      >
        Get Started
      </button>
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <div className="bg-gray-50 rounded-xl shadow-xl p-4 flex flex-col items-center border-t-4 border-primary card-animated fade-in hover:shadow-2xl hover:scale-[1.02] transition-all duration-300" style={{ '--animation-delay': '0.2s' } as React.CSSProperties}>
          ...
          <h3 className="font-bold text-primary-dark mb-1 text-lg font-montserrat text-hover-effect">Log Your Hours</h3>
        ...
        <div className="bg-gray-50 rounded-xl shadow-xl p-4 flex flex-col items-center border-t-4 border-accent card-animated fade-in hover:shadow-2xl hover:scale-[1.02] transition-all duration-300" style={{ '--animation-delay': '0.4s' } as React.CSSProperties}>
          ...
          <h3 className="font-bold text-primary-dark mb-1 text-lg font-montserrat text-hover-effect">Track Progress</h3>
        ...
        <div className="bg-gray-50 rounded-xl shadow-xl p-4 flex flex-col items-center border-t-4 border-primary-dark card-animated fade-in hover:shadow-2xl hover:scale-[1.02] transition-all duration-300" style={{ '--animation-delay': '0.6s' } as React.CSSProperties}>
          ...
          <h3 className="font-bold text-primary-dark mb-1 text-lg font-montserrat text-hover-effect">Get Recognized</h3>
      ...
      {/* Contact Section */}
      <div className="bg-white rounded-xl shadow-lg p-4 max-w-md w-full text-center mt-2 border-t-4 border-primary-dark fade-in">
      ...
      <div className="w-full flex justify-center">
        <div className="text-gray-400 text-xs mt-4 mb-2 text-center max-w-lg flex flex-wrap items-center justify-center gap-2">
