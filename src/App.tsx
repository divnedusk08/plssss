...
function Home() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[60vh] px-2 py-2 bg-white">
      {/* Logo and Title */}
      <div className="flex flex-col items-center mb-4 mt-6 fade-in">
        <div className="relative">
          <svg width="70" height="70" viewBox="0 0 64 64" fill="none" className="torch-animated" xmlns="http://www.w3.org/2000/svg">
            <circle cx="32" cy="32" r="32" fill="#FBBF24" fillOpacity="0.15" />
            <path d="M32 8C28 16 36 20 32 28C36 24 44 20 32 8Z" fill="#FBBF24"/>
            <rect x="29" y="28" width="6" height="24" rx="3" fill="#2563EB"/>
            <rect x="27" y="52" width="10" height="4" rx="2" fill="#FBBF24"/>
      ...
      {/* Tagline */}
      <div className="max-w-md text-center mb-4 fade-in">
        <p className="text-xl text-gray-800 font-montserrat mb-2 text-hover-effect">
      ...
      <button
        ...
        className="mb-6 px-6 py-3 rounded-lg bg-primary text-white font-bold text-lg hover:bg-primary-dark transition glow-on-hover"
      >
        Get Started
      </button>
      {/* How it works section */}
      <div className="w-full max-w-2xl grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-gray-50 rounded-xl shadow-xl p-4 flex flex-col items-center border-t-4 border-primary card-animated fade-in hover:shadow-2xl hover:scale-[1.01] transition-all duration-300" style={{ '--animation-delay': '0.2s' } as React.CSSProperties}>
          <div className="w-14 h-14 bg-primary/10 rounded-full flex items-center justify-center mb-2">
            <svg width="28" height="28" fill="none" viewBox="0 0 24 24" className="torch-animated"><path d="M12 2v20M5 12h14" stroke="#2563EB" strokeWidth="2" strokeLinecap="round"/></svg>
          </div>
          <h3 className="font-bold text-primary-dark mb-1 text-base font-montserrat text-hover-effect">Log Your Hours</h3>
          <p className="text-gray-600 text-xs font-inter text-center text-hover-effect">Submit hours easily. All submissions stored securely.</p>
        </div>
        <div className="bg-gray-50 rounded-xl shadow-xl p-4 flex flex-col items-center border-t-4 border-accent card-animated fade-in hover:shadow-2xl hover:scale-[1.01] transition-all duration-300" style={{ '--animation-delay': '0.4s' } as React.CSSProperties}>
          <div className="w-14 h-14 bg-accent/10 rounded-full flex items-center justify-center mb-2">
            <svg width="28" height="28" fill="none" viewBox="0 0 24 24" className="torch-animated"><path d="M3 17l6-6 4 4 8-8" stroke="#FBBF24" strokeWidth="2" strokeLinecap="round"/></svg>
          </div>
          <h3 className="font-bold text-primary-dark mb-1 text-base font-montserrat text-hover-effect">Track Progress</h3>
          <p className="text-gray-600 text-xs font-inter text-center text-hover-effect">View total hours and history. Stay on top of requirements.</p>
        </div>
        <div className="bg-gray-50 rounded-xl shadow-xl p-4 flex flex-col items-center border-t-4 border-primary-dark card-animated fade-in hover:shadow-2xl hover:scale-[1.01] transition-all duration-300" style={{ '--animation-delay': '0.6s' } as React.CSSProperties}>
          <div className="w-14 h-14 bg-primary-dark/10 rounded-full flex items-center justify-center mb-2">
            <svg width="28" height="28" fill="none" viewBox="0 0 24 24" className="torch-animated"><path d="M12 17l-5 3 1-5.5L3 9.5l5.5-.5L12 4l3.5 5 5.5.5-4 5 1 5.5z" stroke="#1e3a8a" strokeWidth="2" strokeLinejoin="round"/></svg>
          </div>
          <h3 className="font-bold text-primary-dark mb-1 text-base font-montserrat text-hover-effect">Get Recognized</h3>
          <p className="text-gray-600 text-xs font-inter text-center text-hover-effect">Earn recognition for service and leadership. Your impact matters!</p>
        </div>
      </div>
      {/* Contact Section */}
      <div className="bg-white rounded-xl shadow-lg p-4 max-w-xs w-full text-center mt-4 border-t-4 border-primary-dark fade-in">
        <h3 className="font-bold text-primary-dark mb-1 font-montserrat text-hover-effect">Need Help?</h3>
        <p className="text-gray-700 text-sm font-inter text-hover-effect">
      ...
      {/* Not affiliated notice and copyright */}
      <div className="w-full flex justify-center">
        <div className="text-gray-400 text-xs mt-4 mb-2 text-center max-w-xs flex flex-wrap items-center justify-center gap-2">
...
function LogHours({ setDashboardRefreshKey }: { setDashboardRefreshKey: React.Dispatch<React.SetStateAction<number>> }) {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center py-6 px-2 bg-gray-100">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-4">
        <h2 className="text-2xl font-extrabold text-primary-dark text-center font-montserrat mb-4">Log Volunteer Hours</h2>
...
function Admin({ dashboardRefreshKey }: { dashboardRefreshKey: any }) {
  ...
  const processPeriodData = (period: any) => {
    ...
    njhsMembers.forEach((memberName: string) => {
